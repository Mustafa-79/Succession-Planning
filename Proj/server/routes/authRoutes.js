...
const {test, registerUser, loginUser, getProfile, retrieveName, resetPassword, retrieveSecurityQuestion, setPassword, resetSecurityImage, verifySecurityAnswer, submitFeedback, returnProfile} = require('../controllers/authControllers')
