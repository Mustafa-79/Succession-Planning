...
// Component to display the star rating input field. Looks like a row of stars
...
export default function FeedbackForm() {
    ...
    // Menu items for current page. Options to to view career path, personal development plans, feedback tools and settings
    const menuItems = [
        {
            name: "Career Path",
            icon: faHouse,
