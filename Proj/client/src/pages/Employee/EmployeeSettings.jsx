...
export default function EmployeeSettings() {
    ...
    useEffect(() => {
        // Set the title of the page and dispatch the user information
    ...
    // UseEffect to shuffle the security images each time
    useEffect(() => {
    ...
    // Settings page has three tabs for My Profile, Change Password, and Change Security Image respectively
    ...
    // State for the security images
    const [securityImg, setSecurityImg] = useState({
        currentImg: '',
        newImg: ''
    })

    // State for the boolean password validations checks
    ...
    // State for the password match. true if the passwords match, false otherwise
    ...
    // State for the edit information. This is an object with boolean values for each field
    ...
    // State for the edit button. This is a boolean value
    const [enableEdit, setEnableEdit] = useState(false);

    // Function to handle the update box
    const handleUpdateBox = (edit) => {
        setEditInfo(edit)
    }

    // Function to handle the edit submit. flag is a boolean value to determine if the user wants to update the profile or not
    ...
    // Function ti dynamically change the password validations
    ...
    // Function to dynamically change the confirm password validations
    ...
    // If an item is clicked, reset the states
    ...
    // Function to handle the image upload for the profile picture
    ...
    // Function to convert the image to base64. Cannot send the image directly to the server
    ...
    // Function to request the password change from the server
    ...
    // Function to request the security image change from the server
