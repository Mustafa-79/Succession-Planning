...
export default function ResetFinalPwd() {
    ...
    const onPasswordChange = (password) => {
      ...
      setPasswordValidations({
        isLongEnough: password.length >= 15,
        ...
        <body>
          <div class="resetPwd-container">
            <div class="reset-box">
              ...
              <h3>Enter your new password to reset the password on your account. We'll ask this password whenever you log in.</h3>
              <form onSubmit={resetPassword}>
                <div class="input-group">
                  <input type="password" placeholder='New password' value={data.password} onChange={(e) => onPasswordChange(e.target.value)}/>
